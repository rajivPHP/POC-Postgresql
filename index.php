    ...
    <nav>
        ...
        <ul>
            ...
            if (isset($_SESSION['username'])) {
                ?>
                <li>
                    <div class="btn-success" style="margin: 28px;">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" style="margin: 0;color: #000;"><?php echo "Welcome"." ".$_SESSION['name'];  ?></a>
                            <a class="dropdown-item" href="logout.php" style="margin: 0;color: #000;">Logout</a>
                        </div>
                    </div>
                </li>
                <?php
